...
const Welcome = () => {
  ...
  return (
    <div className='sm:flex sm:flex-row mt-5'>
      <div className='basis-[50%] relative h-[350px] justify-center items-center flex flex-col bg-[length:100%_auto] coin'>
        ...
        {!currentAccount && (<div className='my-5 flex justify-center w-full'>
